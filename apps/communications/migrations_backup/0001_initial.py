# Generated by Django 5.2.3 on 2025-07-16 13:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_secret', models.CharField(help_text='Secreto de la aplicación de Facebook', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('team_leader_asignado', models.ForeignKey(blank=True, help_text='Team Leader asignado al cliente', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='clientes_asignados', to='sales_team_management.teamleader')),
                ('vendedor_asignado', models.ForeignKey(blank=True, help_text='Vendedor asignado al cliente', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='clientes_asignados', to='sales_team_management.vendedor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('cliente', models.OneToOneField(help_text='Cliente de la conversación', on_delete=django.db.models.deletion.CASCADE, related_name='conversacion', to='whatsapp_business.cliente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('cliente', models.ForeignKey(help_text='Cliente que genera el lead', on_delete=django.db.models.deletion.CASCADE, related_name='leads', to='whatsapp_business.cliente')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team_leader', models.ForeignKey(help_text='Team Leader asignado', on_delete=django.db.models.deletion.CASCADE, related_name='asignaciones_leads', to='sales_team_management.teamleader')),
                ('vendedor', models.ForeignKey(help_text='Vendedor asignado', on_delete=django.db.models.deletion.CASCADE, related_name='asignaciones_leads', to='sales_team_management.vendedor')),
                ('lead', models.ForeignKey(help_text='Lead asignado', on_delete=django.db.models.deletion.CASCADE, related_name='asignaciones', to='whatsapp_business.lead')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('conversacion', models.ForeignKey(help_text='Conversación a la que pertenece el mensaje', on_delete=django.db.models.deletion.CASCADE, related_name='mensajes', to='whatsapp_business.conversacion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('cliente', models.ForeignKey(help_text='Cliente comprador', on_delete=django.db.models.deletion.CASCADE, related_name='procesos_venta', to='whatsapp_business.cliente')),
                ...
                ('lead', models.ForeignKey(blank=True, help_text='Lead que originó el proceso (opcional)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='procesos_venta', to='whatsapp_business.lead')),
                ('team_leader', models.ForeignKey(help_text='Team Leader supervisor', on_delete=django.db.models.deletion.PROTECT, related_name='procesos_venta', to='sales_team_management.teamleader')),
                ('vendedor', models.ForeignKey(help_text='Vendedor responsable', on_delete=django.db.models.deletion.PROTECT, related_name='procesos_venta', to='sales_team_management.vendedor')),
                ('tipo_pago', models.ForeignKey(help_text='Tipo de pago seleccionado', on_delete=django.db.models.deletion.PROTECT, related_name='procesos_venta', to='whatsapp_business.tipopago')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('cita_padre', models.ForeignKey(blank=True, help_text='Cita padre (para seguimientos)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='citas_seguimiento', to='whatsapp_business.cita')),
                ...
                ('vendedor', models.ForeignKey(help_text='Vendedor responsable de la cita', on_delete=django.db.models.deletion.CASCADE, related_name='citas', to='sales_team_management.vendedor')),
                ('cliente', models.ForeignKey(help_text='Cliente de la cita', on_delete=django.db.models.deletion.CASCADE, related_name='citas', to='whatsapp_business.cliente')),
                ('lead', models.ForeignKey(blank=True, help_text='Lead asociado a la cita', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='citas', to='whatsapp_business.lead')),
                ('proceso_venta', models.ForeignKey(blank=True, help_text='Proceso de venta asociado', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='citas', to='whatsapp_business.procesoventa')),
            ],
            options={
                'verbose_name': 'Cita',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('lead', models.ForeignKey(help_text='Lead al que pertenece el seguimiento', on_delete=django.db.models.deletion.CASCADE, related_name='seguimientos', to='whatsapp_business.lead')),
                ('proceso_venta', models.ForeignKey(blank=True, help_text='Proceso de venta asociado', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='seguimientos', to='whatsapp_business.procesoventa')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('proceso_venta', models.OneToOneField(help_text='Proceso de venta que generó esta venta', on_delete=django.db.models.deletion.CASCADE, related_name='venta_inmutable', to='whatsapp_business.procesoventa')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('venta_inmutable', models.OneToOneField(help_text='Venta inmutable asociada', on_delete=django.db.models.deletion.CASCADE, related_name='contrato', to='whatsapp_business.ventainmutable')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.ForeignKey(help_text='Template a utilizar', on_delete=django.db.models.deletion.CASCADE, related_name='campañas', to='whatsapp_business.whatsapptemplate')),
            ],
            options={
