...
class WhatsAppConfigForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'app_secret': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'Secreto de la aplicación (opcional)'
            }),
        ...
        labels = {
            ...
            'app_secret': 'Secreto de la Aplicación (Opcional)',
        ...
        help_texts = {
            ...
            'app_secret': 'Secreto de la aplicación de Facebook (opcional, solo para validaciones avanzadas)',
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Hacer que todos los campos sean requeridos excepto is_active, whatsapp_business_account_id y app_secret
        for field_name, field in self.fields.items():
            if field_name not in ['is_active', 'whatsapp_business_account_id', 'app_secret']:
                field.required = True
